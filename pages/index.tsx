  ...
  return (
    <div className="px-5 md:px-10 pb-20 lg:max-w-[620px] absolute lg:left-1/2 lg:-translate-x-1/2">
      ...
      <div className="post-content text-lg text-gray900">
        <p className="">
          I'm a <span className="font-medium font-primary-medium">full-stack developer</span> by profession, currently a
          consultant at ESPN re-writing world's largest cricket platform{' '}
